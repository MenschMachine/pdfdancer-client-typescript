...
describe('Path E2E Tests (New API)', () => {
    ...
    test('change path stroke color', async () => {
        ...
        await assertions.assertPathStrokeColor('PATH_0_000001', new Color(255, 0, 0));
    });
    ...
    test('change path fill color', async () => {
        ...
        await assertions.assertPathFillColor('PATH_0_000004', new Color(0, 0, 255));
    });
    ...
    test('add stroke to fill-only path', async () => {
        ...
        await assertions.assertPathStrokeColor('PATH_0_000004', new Color(255, 0, 0));
        await assertions.assertPathFillColor('PATH_0_000004', new Color(0, 0, 0));
    });
    ...
    test('set path stroke and fill colors simultaneously', async () => {
        ...
        await assertions.assertPathStrokeColor('PATH_0_000003', new Color(255, 0, 0));
        await assertions.assertPathFillColor('PATH_0_000003', new Color(0, 0, 255));
    });
